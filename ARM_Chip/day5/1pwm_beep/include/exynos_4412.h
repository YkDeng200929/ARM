...
#define		CLK_SRC_LBUS		__REG(0x10034200)
...
typedef	struct {
				...
				unsigned int BCDDAY;
				unsigned int BCDWEEK;//太坑我了，手册上写的是错的地址
				unsigned int BCDMON;
...
/********************************** Interrupt Combiner  ***********************************/
/* Interrupt Combiner Group 0*/
typedef struct {
				//registers for group 0~3
				unsigned int IESR0;
				unsigned int IECR0;
				unsigned int ISTR0;
				unsigned int IMSR0;
				//registers for group 4~7
				unsigned int IESR1;
				unsigned int IECR1;
				unsigned int ISTR1;
				unsigned int IMSR1;
				//registers for group 8~11
				unsigned int IESR2;
				unsigned int IECR2;
				unsigned int ISTR2;
				unsigned int IMSR2;
				//registers for group 12~15
				unsigned int IESR3;
				unsigned int IECR3;
				unsigned int ISTR3;
				unsigned int IMSR3;
				//registers for group 16~17
				unsigned int IESR4;
				unsigned int IECR4;
				unsigned int ISTR4;
				unsigned int IMSR4;
}intcombiner;
#define INTCOMBINER ( * (volatile intcombiner *) 0x10440000 )
